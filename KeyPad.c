...
{																																			//Intialize 2 ports to be used for keypad , highest 4 pins in IN_portname is intialized to be input pull up bottons	
	DIO_vSETPINDIR (OUT_portname,0,1);
...
unsigned char KEYPAD_u8READ(unsigned char OUT_portname,unsigned char IN_portname)// this function reads what is pressed on keypad *send to this function port names that the keypad is connected to it*
